...
-webkit-linear-gradient(-45deg, rgba(198,198,198,0.43) 0%, rgba(204,204,204,0.01) 21%,rgba(213,213,213,0.37) 55%,rgba(221,221,221,0) 83%,rgba(226,226,226,0.42) 100%) !important;\
	...
	var dzieShto = [
        {
            addr: 'ibb.by',
            css:'img[src $="icons/russian.gif"]{ '+ flagCSS +'; width: 16px; height: 12px; vertical-align: top; '+ boxShadow(0.18) +'}'
        },
        {
            addr: 'pbliga.com',
            css:'img[src $="flags/flag_17.png"]{ '+ flagCSS +'; width: 22px; height: 18px; vertical-align: middle; '+ boxShadow(0.25) +'}'
        },
        {
            addr: 'tamby.info',
        ...
        },
        {
            ...
            css:'img[src $="/flags/1.jpg"]{ '+ flagCSS +'; display: inline-block !important; width: 16px; height: 11px; '+ boxShadow(0.3) +'}'
        },
        {
            addr: 'pefl.ru',
        ...
        {
            addr: 'sports.ru',
            css:'.flag-s.flag-1302{ '+ flagCSS +'; }'
        },
        {
            addr: 'busuu.com',
            css:'img.flag[src $="/flags/by.gif"]{ '+ flagCSS +'; display: inline-block !important }'
        },
        {
        ...
        },
        {
            ...
            css:  'body #menu li.sprite .flag span.by {'+ flagCSS +' height: 12px; background-position: 0 0, 0 0 !important; position: relative; top: 1px;}'
        },
        {
            addr: 'slando.by',
            css:  'img[src $="flags/by.png"] {'+ flagCSS +'; height: 12px; width: 16px;}'
        },
        {
            addr: 'samsungapps.com',
            css:  'img[src $="flag/BY.png"]:not(.fakeclassforspecificity) {'+
                        + flagCSS +'; \
                        height: 12px; \
                        width:18px;\
                        border:0\
        ...
        },
        {
            ...
            css: 'img[src $="flag_header_freeads.by.gif"] {content:"";background:50% no-repeat url("'+sciahSphereSrc+'"); background-size: 35px 35px;}\
                  img[src $="flags/flag_icon_freeads.by.gif"] {'+
                      flagCSS +'\
                      '+ boxShadow(0.65) +
                  '}'
        },
		...
		{ addr: 'kvitki.by',
		  css:'img[src $="lang_by.gif"], img[src $="lang_by_ov.gif"] {'+flagCSS+';width:16px;height:12px;} img[src $="lang_by_ov.gif"]{opacity: .6}'
		},
		{ addr: 'cybergames.by',
		...
		{ addr: 'kinopoisk.ru',
		css:'.flag69 * {'+flagCSS+'; height:12px}.flag.flag69{height: 12px;} .tenItems .flags{height: auto !important}.movieFlags .flag69 * {height: 10px;}\
...
box-shadow:inset 0 0 0 1px #333,inset 0 0 0 2px rgba(255,255,255,.6); \
	...
	var addCSS = function(CSS) {
		...
		styleEl.setAttribute('class', 'CorrectFlag');
