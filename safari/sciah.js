...
-webkit-box-shadow:inset 0 0 0 1px rgba(0,0,0,.15);\
   -moz-box-shadow:inset 0 0 0 1px rgba(0,0,0,.15);\
	...
	var dzieShto = [
		...
		{ addr: 'livetv.ru',
			css:'img[src $="national/by.gif"]{'+flagCSS+'width:16px;height:12px;}\
...
box-shadow:inset 0 0 0 1px #333,inset 0 0 0 2px rgba(255,255,255,.6); \
		...
		{ addr: 'pac.by',
		  css: '.by_l_by {width:16px} .by_l_by img{display:none;}' +
			   ' .by_l_by a::before{'+flagCSS+'width:16px;height:12px;display:block}' +
			   '.by_l_by a::after{width:16px;height:9px;display:block;content:"";'+ reflectionDownCSS +'}'
		}
	];
